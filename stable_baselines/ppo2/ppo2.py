...
from stable_baselines.common.runners import AbstractEnvRunner, AbstractDictEnvRunner
...
class PPO2(ActorCriticRLModel):
    ...
    def _make_runner(self):
        return DictRunner(env=self.env, model=self, n_steps=self.n_steps,
    ...
    def _train_step(self, learning_rate, cliprange, obs, returns, masks, actions, values, neglogpacs, update,
        ...
        td_map = {**{self.train_model.obs_ph[k]: obs[k] for k in range(len(obs))}, self.action_ph: actions,
